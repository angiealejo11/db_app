...
class SubscriptionHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscription_history" do
    assert_difference('SubscriptionHistory.count') do
      post subscription_histories_url, params: { subscription_history: { : @subscription_history., canceled_times: @subscription_history.canceled_times } }, as: :json
    end
  ...
  test "should update subscription_history" do
    patch subscription_history_url(@subscription_history), params: { subscription_history: { : @subscription_history., canceled_times: @subscription_history.canceled_times } }, as: :json
    assert_response 200
  end
